...
public class emailTemplate {
    public static String getWLCmail(String name,String email,String verificationCode){
       ...
       return "<!DOCTYPE html>\r\n" + //
                        ...
                        "            <p id=\"text\">\r\n" + //
                        "                Welcome " + name + ", r\n" + //
                        "                Click over the <a href='http://localhost:8080/68_passwordEncryption/verify.do?email=" + email + "&verification_code=" + verificationCode + "'>verification link</a> to verify your email and activate your account! r\n" + //                        
                        "                Regards,  r\n" + //
                        "                ISRDC Jabalpur,  r\n" + //
                        "            </p>\r\n" + //
                        "        </div>\r\n" + //
